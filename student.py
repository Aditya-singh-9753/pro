...
def generate_student_data(num_students=10000):
    ...
    for i in range(num_students):
        ...
        num_pages_visited = random.randint(1, 10)  
        clicks_on_admission_page = random.randint(0, 1)  
        student_score = random.randint(600, 800) 
        application_submitted = random.randint(0, 1) 
